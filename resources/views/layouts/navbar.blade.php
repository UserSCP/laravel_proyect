<nav class="navbar" style="position:sticky;"
    <div class="navbar-left">
        <ul class="sticky navbar" style="position: sticky">
            <li class="navbar-fix"><a class="{{ request()->routeIs('home') ? 'active' : '' }}" href="{{ route('home') }}">{{ __('fields.navbar.home') }}</a></li>
            <li class="navbar-fix"><a class="{{ request()->routeIs('products.index', 'products.create', 'products.edit') ? 'active' : '' }}"
                    href="{{ route('products.index') }}">{{ __('fields.navbar.option1') }}</a></li>
            <li class="navbar-fix"><a class="{{ request()->routeIs('categories.index', 'categories.create', 'categories.edit') ? 'active' : '' }}"
                    href="{{ route('categories.index') }}">{{ __('fields.navbar.option2') }}</a></li>
            <li class="navbar-fix"><a class="{{ request()->routeIs('brands.index', 'brands.create', 'brands.edit') ? 'active' : '' }}"
